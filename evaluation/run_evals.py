...
evaluation should focus on which reasoning is more logical, unbiased, and realistic.
Do not evaluate the reasonings based on whether or not they {{things to avoid}}.
