...
class ForecastingRLHF(Dataset):
    def __init__(self, data_path: str):
        ...
        self.instruction_template = "Below is an instruction that describes a task. " + \
                          ...
                          "### Instruction:\n{instruction}\n\n### Response:"
        self.prompt_template = """Here is a forecasting question: {question}\n\nHere are the resolution criteria of the question: {resolution_criteria}.\n\nBased on the forecasting question and resolution criteria, generate {quality_type} quality step-by-step reasoning to create a resolution. Output only steps without an introduction or a conclusion."""
    ...
    def get_dataset(self):
        ...
        prompts = [self.format_prompt(self.df['question'][idx], self.df['resolution_criteria'][idx]) for idx in range(len(self.df))]
